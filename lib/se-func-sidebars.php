...
function se_sidebars_init() {
  ...
  register_sidebar( array(
   ...
   'before_widget' => '<div class="wpp-sidebar" >',
   'after_widget' => '</div>',
  ...
  register_sidebar( array(
   ...
   'before_widget' => '<aside class="wpp-sidebar footer_left">',
   'after_widget' => '</aside>',
   'before_title' => '<h1>',
   'after_title' => '</h1>',
  ) );
  ...
  register_sidebar( array(
   ...
   'before_widget' => '<aside class="wpp-sidebar footer_middle">',
   'after_widget' => '</aside>',
   'before_title' => '<h1>',
   'after_title' => '</h1>',
  ) );
  ...
  register_sidebar( array(
   ...
   'before_widget' => '<aside class="wpp-sidebar footer_right">',
   'after_widget' => '</aside>',
   'before_title' => '<h1>',
   'after_title' => '</h1>',
  ) );
  ...
  register_sidebar( array(
   ...
   'before_widget' => '<aside class="article_top ad">',
   'after_widget' => '</aside>',
   'before_title' => '<span class="title ad-label">',
   'after_title' => '</span>',
  ) );
